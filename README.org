...
#+BEGIN_EXAMPLE
gcc -Wall -Werror -Wextra -pedantic src/main.c src/init_instance.c src/draw_functions.c src/map_functions.c src/game_functions.c src/paint_functions.c $(sdl2-config --cflags) $(sdl2-config --libs)
#+END_EXAMPLE
